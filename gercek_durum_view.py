...
from styles import BORDER, INK, OK as POZ, BAD as NEG, PANEL_BG, PRIMARY_SOFT
...
def build_gercek_durum_widget(gd: GercekDurum, firma: str = "") -> QWidget:
    ...
    # Hero: fiili brüt marj önde (Teal A — 1 ana metrik)
    hero = QFrame()
    ...
    # Trend full-width; nakit paneli altında tek satır
