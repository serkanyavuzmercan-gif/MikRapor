...
İlk açılışta üstteki **«Mikro Ayarları»**'ndan kendi Mikro sunucu bilgilerinizi girin (API adresi, anahtar, firma kodu, çalışma yılı, kullanıcı, şifre). **Bağlantıyı Test Et** → **Kaydet**. Bilgiler `%APPDATA%\MikRapor\config.json` içinde, yalnızca sizin bilgisayarınızda tutulur.
